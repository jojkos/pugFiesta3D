...
const cs = {
  ...
  results: {
    ...
    top3: 'TOP 3 — mopsí elita!',
    top10: 'Top 10! Slušná jízda.',
    tryAgain: 'Štěkals, ale nekousal.',
    best: 'Rekord',
    rank: 'Pořadí',
    again: 'JEŠTĚ JEDNOU!',
    saveFirstNudge: 'Skóre nemáš uložené! Klikni znovu, pokud chceš odejít bez uložení.',
  },
  leaderboard: {
    title: 'Mopsíň slávy',
    ...
    submitFailed: 'Zápis se nepovedl. Zkus to prosím znovu.',
    retry: 'Zkusit znovu',
...
const en: typeof cs = {
  ...
  results: {
    ...
    suffix: 'latched',
    newBest: 'NEW TOP SCORE — top pug supreme!',
    top3: 'TOP 3 RUN — pug elite!',
    top10: 'Top 10! Solid run.',
    tryAgain: 'Tighten that timing and go pug yourself.',
    best: 'Best',
    rank: 'Rank',
    again: 'ONE MORE!',
    saveFirstNudge: "Your score isn't saved! Click again to leave without saving.",
  },
  leaderboard: {
    ...
    submitFailed: 'Couldn\'t save your score. Please try again.',
    retry: 'Try again',
